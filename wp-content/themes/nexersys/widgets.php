...
** Widget_Sidebar_Menu
*/
class Widget_Sidebar_Menu extends WP_Widget{
 function Widget_Sidebar_Menu() {
  $widget_ops = array('description' => __( "Widget Description" ), 'classname' => 'widget-sidebar-menu' );
  $this->WP_Widget('sidebar-menu', __('Sidebar Menu'), $widget_ops);
 }
 function widget($args, $instance) {
  extract( $args );
  ...
  wp_nav_menu(array('fallback_cb' => '','menu' => $nav_menu,'menu_class' => ''));
  echo $after_widget;
 }
...
add_action('widgets_init', create_function('', 'return register_widget("Widget_Sidebar_Menu");'));
