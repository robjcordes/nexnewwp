...
function initGallery() {
	jQuery('.carousel').each(function() {
		...
		var list = holder.find('.gmask > ul');
		var btnNext = holder.find('.btn-next');
		var btnPrev = holder.find('.btn-prev');
		var btnPause = holder.find('.btn-pause');
		var pagerList = holder.find('.pagination ul');
		var pagers = pagerList.find('li');
		var p = true;
...
function initSameHeight(){
	// basic examples
	jQuery('div.container_12').sameHeight({
...
browserPlatform = {
	platforms: [
		...
		{ uaString:'ipad', cssFile:'ipad.css', miscHead:'<meta name="viewport" content="width=960" />' }, // iPad
		{ uaString:['safari','mobi'], cssFile:'safari.css', miscHead:'<meta name="viewport" content="width=960" />' } // iPhone and other webkit browsers
	],
	options: {
		cssPath:'css/',
