...
$allvideogallery_plugin_dir = basename(dirname(__FILE__));
...
function allvideogallery_plugin_css() {
	global $allvideogallery_plugin_dir;
    $url = get_option('siteurl') . '/wp-content/plugins/' . $allvideogallery_plugin_dir . '/allvideogallery.css';
...
function allvideogallery_plugin_menu() {
	global $allvideogallery_plugin_dir;
    $icon = get_option('siteurl') . '/wp-content/plugins/' . $allvideogallery_plugin_dir . '/assets/icon.png';
...
if (is_admin()) {
	...
	add_action('plugins_loaded', 'allvideogallery_update_db_check');
