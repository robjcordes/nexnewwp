...
echo "<h3>" . __( "Limit the Gallery Display" ) . "</h3>";
_e( "Sometimes, you may want to limit the count of thumbnails to be displayed with the Gallery. This could be achieved by simply using a <strong>count</strong> attribute.<br /><i><strong>Example 1 : </strong>[allvideogallery profile=1 sort=latest count=10]</i> will display 10 recently added video thumbnails." );
