	...
	public function buildGallery( $arr ) {
		...
		$output .= '<div id="' . $custid . '">';
  		...
  		for ($i=0, $n=$limit; $i < $n; $i++) {
            ...
            $output .= '<img class="arrow" src="' . get_option('siteurl') . '/wp-content/plugins/' . $allvideogallery_plugin_dir . '/assets/play.gif" style="margin-left:' . ($arr['thumb_width'] - 30) / 2 . 'px; margin-top:' . ($arr['thumb_height'] - 26) / 2 . 'px" border="0" />';
