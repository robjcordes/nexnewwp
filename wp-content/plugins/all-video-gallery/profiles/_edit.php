...
<div class="wrap">
  <form method="POST" action="<?php echo $_SERVER['REQUEST_URI']; ?>" onsubmit="return allvideogallery_validate();">
    ...
    <table cellpadding="0" cellspacing="10">
      <tr>
        <td width="175"><?php _e("Profile Name"); ?></td>
    ...
    <table cellpadding="0" cellspacing="10">
      <tr>
      	<td>
        	<input type="hidden" name="controlbar" value="0">
        ...
        <td>
        	<input type="hidden" name="durationdock" value="0">
        ...
        <td>
        	<input type="hidden" name="timerdock" value="0">
        ...
        <td>
        	<input type="hidden" name="fullscreendock" value="0">
      ...
      <tr>
        ...
        <td>
        	<input type="hidden" name="facebookdock" value="0">
        ...
        <td>
        	<input type="hidden" name="twitterdock" value="0">
    ...
    <table cellpadding="0" cellspacing="10">
      <tr>
        <td width="175"><?php _e("Controlbar Outline Color"); ?></td>
    ...
    <table cellpadding="0" cellspacing="10">
      <tr>
        <td width="175"><?php _e("No of Rows"); ?></td>
    ...
    <table cellpadding="0" cellspacing="10">
      <tr>
      	<td width="175"><?php  echo "<h3>" . __( 'Custom Page URL' ) . "</h3>"; ?></td>
        <td><input type="text" id="custom_page_url" name="custom_page_url" value="<?php echo $data->custom_page_url; ?>" size="50"><?php _e("<a href='http://allvideogallery.mrvinoth.com/custom-player-page-url' target='_blank' style='margin-left:10px; text-decoration:none; font-weight:bold;'>What is this ?</a>"); ?></td>
      </tr>
    </table>
    <br />
