...
//			Global media options
				...
				autoplay: WP_MEDIA_LB_AUTOPLAY,			// Plays the video as soon as it's opened
...
//			NonverBlaster
				...
				playerpath: WP_LIGHTBOX_PLUGIN_URL+'/lib/js/NonverBlaster.swf',	// Path to NonverBlaster.swf
				controlColor: '0xFFFFFF',	// set the controlbar color
				controlBackColor: '0x000000',	// set the controlbar color
				showTimecode: 'false',		// turn timecode display off or on
//			JW Media Player settings and options
				JWplayerpath: WP_LIGHTBOX_PLUGIN_URL+'/lib/js/player.swf',	// Path to the mediaplayer.swf or flvplayer.swf file
